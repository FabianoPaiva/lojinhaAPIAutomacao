...
public class ProdutoTest {
    ...
    public void testValidarLimitesZeradoProibidoValorProduto() {
        // Inserir um produto com valor 0.00, que a mensagem de erro foi apresentada e o
    ...
    public void testValidarLimitesMaiorSeteMilProibidoValorProduto() {
        // Inserir um produto com valor 7000.01, que a mensagem de erro foi apresentada e o
        // status code retornado foi 422
        given()
                .contentType(ContentType.JSON)
                .header("token", this.token)
